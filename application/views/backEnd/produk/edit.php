	...
	<div class="card card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nama_produk" value="<?= $produk->nama_produk ?>" id="nama_produk" placeholder="Nama Produk">
			</div>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						<label for="">Ganti Gambar </label><span></span>
				...
				<div class="col-sm-6">
					<div class="form-group">
						<img src="<?= base_url('assets/gambar/' . $produk->gambar) ?>" id="gambar_load" width="400px" class="img img-fluid" alt="">
					</div>
				</div>
			</div>
