<div class="col-md-12">
	<div class="card card-purple">
		<div class="card-header">
			<h3 class="card-title">Ganti Foto Galeri</h3>
		</div>
		<div class="card-body">
			<?php
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<select name="id_kategori_galeri" class="form-control" id="">
							<option value="<?= $galeri->id_kategori_galeri ?>"><?= $galeri->nama_kategori_galeri ?></option>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<img src="<?= base_url('assets/galeri_foto/' . $galeri->foto) ?>" id="gambar_load_galeri" width="450px" class="img img-fluid" alt="">
						</div>
					</div>
					<div class="form-group">
