			...
			<div class="blocks-items-card">
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="<?= base_url(); ?>assets/img/img-home-4.jpg" alt="" class="img card-img">
							</div>
							<div class="card-body text-center">
								...
								<div class="link-paket">
									<a href="<?= base_url(); ?>detail_paket/paket_bronze" class="item-btn">Lihat Detail</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="<?= base_url(); ?>assets/img/thumbnail (6).jpg" alt="" class="img card-img">
							</div>
							<div class="card-body text-center">
								<div class="title-card ">
									<h3>Paket B</h3>
					...
					<div class="col-md-4">
						<div class="card">
							<div class="pict">
								<img src="<?= base_url(); ?>assets/img/img-home-3.jpg" alt="" class="img card-img">
							</div>
							<div class="card-body text-center">
								<div class="title-card ">
									<h3>Paket C</h3>
